...
enc_layers_47 = tf.keras.models.clone_model( model_list[9].layers[1] )
...
model_cls_47, history = tools.train_gen(
    ...
    initial_learning_rate=m_ini_learning_rate, logpath = '../Outputs/Logs/Conv3D_nC'+str(47)+'_LOS'+str(out_Session)+'_')
#% test mode
